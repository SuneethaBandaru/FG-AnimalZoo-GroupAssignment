...
const animals = [
    ...
    },
    {
        ...
        fullDescription: "Until recently, it was only found on the island state of Tasmania, but it has been reintroduced to New South Wales in mainland Australia, with a small breeding population. The size of a small dog, the Tasmanian devil became the largest carnivorous marsupial in the world, following the extinction of the thylacine in 1936. It is related to quolls, and distantly related to the thylacine. It is characterised by its stocky and muscular build, black fur, pungent odour, extremely loud and disturbing screech, keen sense of smell, and ferocity when feeding. The Tasmanian devil's large head and neck allow it to generate among the strongest bites per unit body mass of any extant predatory land mammal. It hunts prey and scavenges on carrion.",
        length: "70cm",
        weight: "10kg",
        found: "Tasmania",
        image: "../images/mammals/tasmanian-devil-transparent.png"
    },
    {
        name: "Quokka",
        id: "quokka",
        ...
        fullDescription: "His first sighting of the Quokka was on an island off the mouth of the Swan River. He named the island Rottenest ('rat nest') in honour of this sighting. The island is now known as Rottnest Island. Essentially the Quokka looks very much like other wallabies.It has short, very coarse and thick grey-brown fur over most of the body with lighter parts underneath. Its facial features consist of a naked nose on a short, broad face with rounded furry ears.The tail is relatively short and mostly devoid of hair. In contrast, the hair on the feet extends to cover its claws.",
        length: "50cm",
        weight: "3kg",
        found: "Rottnest Island and WA mainland",
        image: "../images/mammals/quokka1-transparent.png",
    },
];

const welcomeMsg = `We proudly present our mammals, The Echidna is a spiny mammal that eats insects with its long tongue, the Tasmanian Devil is the largest carnivorous marsupial known for its powerful bite and loud screeches, and the quokka is a small, herbivorous, and happiest marsupial found on islands off Western Australia.`;

const mainContainer = document.getElementById("mainContent");

const welcomeDiv = document.createElement("div");
welcomeDiv.classList.add("welcome-message"); // add CSS class
...
function createListInsideDiv() {
    ...
    animals.forEach(animal => {
        ...
        li.onclick = function () {
            ...
            // Short summary
            //add div with short summary
            const shortDesc = document.createElement("div");
            shortDesc.textContent = animal.shortDescription;
            shortDesc.classList.add("animal-short-desc");
            mainContent.appendChild(shortDesc);
            // Read More link
            //add read more hyperlink with text
            const readMore = document.createElement("a");
            readMore.textContent = "Read More";
            readMore.href = "#";
            readMore.classList.add("read-more");
            mainContent.appendChild(readMore);

            // Full description div with smooth collapse/expand
            //add div with brief summary when cliked on the read more text
            ...
            mainContent.appendChild(fullDesc);

            // Read Less link
            //add red less hyperlink with text
            ...
            mainContent.appendChild(readLess);

            // Read More click
            //on click the read more button needs to expand the brief summary div
            ...
            // Read Less click
            //on click the read less button needs to collapse the brief summary div
